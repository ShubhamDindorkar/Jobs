...
// Upside-down lamp component
export const UpsideDownLamp = ({
  children,
  className,
}: {
  children: React.ReactNode;
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 rotate-180">
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
          transition={{
